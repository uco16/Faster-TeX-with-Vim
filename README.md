...
Using Vim-Plug is a convenient way to get out-of-the-box installation. This method has been tested on Afiq's computer (Mac OS). Firstly, install Vim-Plug by reading the instructions [here](https://github.com/junegunn/vim-plug). To do this quickly, just go on your terminal and type in `curl -fLo ~/.vim/autoload/plug.vim --create-dirs \
...
when you're in vim, make sure to run `source:~/.virmc`.   
